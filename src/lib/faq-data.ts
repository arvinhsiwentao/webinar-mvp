...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      ...
      '包含价值灯号、Mike 关注清单、语音直播、学员 & Mike 即时文字聊天室、APP 专属付费内容文章等功能，是你的投资学习 + 实战工具。\n\n' +
      '2. 震荡行情的美股期权操作解析（线上课程）\n' +
      '教你用 Sell Put、Sell Call 在市场波动时收保费，是直播中讲的「攻守框架」防守端的完整教学。无期限、无限次数观看。\n\n' +
      '3. ETF 进阶资产放大术（线上课程）\n' +
      '教你四类 ETF 组合配置、从退休目标倒推配比、长短线账户策略，是「攻守框架」进攻端的完整教学。无期限、无限次数观看。\n\n' +
  ...
  },
  {
    ...
    answer:
      ...
      'APP 权限为一年期（自启用日起算），到期后可续费继续使用社群、直播和工具功能。',
  },
];

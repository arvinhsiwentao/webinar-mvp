          ...
          <div className="lg:sticky lg:top-8 lg:self-start space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 Wei Z.</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 陈先生</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 Jenny C.</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 林先生</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 Alex W.</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 黄女士</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 Yiming L.</p>
              </div>
              ...
              <div className="border-l-4 border-[#B8953F] bg-white rounded-r-lg p-5">
                ...
                <p className="text-xs text-neutral-400">— 学员 赵先生</p>
              </div>
            </div>
